    ...
    return (
        <form>
            <div className="px-80 py-20 space-y-12">
                ...
                <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div className="col-span-full">
                            ...
                            <p className="mt-3 text-sm leading-6 ">Escreva sobre voc&ecirc;...</p>
                        </div>
                ...
                <div className="border-b border-gray-900/10 pb-12">
                    <h2 className="text-base font-semibold leading-7 ">Notifica&ccedil;&otilde;es</h2>
                    <p className="mt-1 text-sm leading-6 ">
                        Sempre informaremos sobre mudan&ccedil;as importantes, mas voc&ecirc; escolhe o que mais deseja receber.
                    </p>

                    <div className="mt-10 space-y-10">
                        <fieldset>
                            <legend className="text-sm font-semibold leading-6 ">Por e-mail</legend>
                            <div className="mt-6 space-y-6">
                                <div className="relative flex gap-x-3">
                                    ...
                                    <div className="text-sm leading-6">
                                        ...
                                        <p className="text-gray-500">Seja notificado quando houver promo&ccedil;&otilde;es.</p>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
                        <fieldset>
                            <legend className="text-sm font-semibold leading-6 ">Por SMS</legend>
                            <p className="mt-1 text-sm leading-6 ">Estes s&atilde;o entregues via SMS no seu telefone celular.</p>
                            <div className="mt-6 space-y-6">
